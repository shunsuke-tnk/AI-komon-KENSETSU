...
export const CTASection: React.FC = () => {
  return (
    <div className="bg-gradient-to-br from-white via-gray-50 to-gray-100 text-black py-16 md:py-24 lg:py-32 px-4 sm:px-6 overflow-hidden relative">
      ...
      <div className="max-w-[1200px] mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter leading-[0.9] mb-8">
        ...
        <div className="max-w-2xl mx-auto text-center mb-12">
          <p className="text-lg sm:text-2xl md:text-3xl font-medium leading-relaxed mb-6">
            「何を導入すべきかわからない」<br />
            「どこを改善すべきかわからない」
          </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 mb-12 text-center">
          ...
          <p className="font-bold text-base sm:text-lg">押し売りは一切ありません。診断だけでもOK。</p>
        </div>
        ...
        <div className="text-center">
          <Link
            to="/contact"
            className="group relative inline-flex items-center justify-center font-black tracking-wider transition-all duration-300 px-6 py-4 sm:px-12 sm:py-6 md:px-16 md:py-8 text-base sm:text-xl md:text-2xl bg-gradient-to-b from-orange-500 via-orange-600 to-orange-700 text-white rounded-lg shadow-[0_10px_40px_rgba(234,88,12,0.5)] hover:shadow-[0_15px_50px_rgba(234,88,12,0.7)] hover:-translate-y-1 border-t-2 border-orange-400 overflow-hidden animate-heartbeat"
          >
            <span className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700"></span>
            <span className="relative">無料AI活用診断に申し込む</span>
            <ArrowRight className="relative ml-2 sm:ml-4 w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 group-hover:translate-x-1 transition-transform" />
          </Link>
